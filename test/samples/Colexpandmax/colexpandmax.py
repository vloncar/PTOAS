...
def build():
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            tile_view_32x32 = pto.PartitionTensorViewType.get([32, 32], f32, ctx)
            tile_view_1x32 = pto.PartitionTensorViewType.get([1, 32], f32, ctx)
            ...
            tile_buf_1x32 = pto.TileBufType.get([1, 32], f32, vec, [1, 32], cfg, ctx)
            ...
            with InsertionPoint(entry):
                ...
                tb2 = pto.AllocTileOp(tile_buf_32x32).result

                pto.TLoadOp(None, sv0, tb0)
                pto.TLoadOp(None, sv1, tb1)

                pto.TColExpandMaxOp(tb0, tb1, tb2)
