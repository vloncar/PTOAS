...
def build():
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            # Keep shapes aligned with the existing GEMV samples to ensure the
            # generated kernel compiles and runs on Ascend910.
            M = 1
            M_ALIGN = 16
            K = 256
            N = 32
            ...
            with InsertionPoint(entry):
                ...
                # The point of this testcase: exercise TEXTRACT (Mat -> Left).
                pto.TExtractOp(a_mat, c0, c0, a_tile)

                # Keep the rest minimal but produce a storable output (ACC -> GM).
